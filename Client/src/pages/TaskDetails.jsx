...
const TaskDetails = () => {
    ...
    const handleAddComment = async () => {
        ...
        try {
            ...
            const updated = [...comments, dummyComment];
            setComments(updated);
            localStorage.setItem(`comments_${taskId}`, JSON.stringify(updated));
            setNewComment("");
            toast.dismissAll();
                ...
                <div className="p-5 rounded-md bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 ">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700 dark:text-zinc-300">
                        <div className="flex items-center gap-2">
                            <img src={task.assignee?.image || `https://ui-avatars.com/api/?name=Unassigned&background=random`} className="size-5 rounded-full" alt="avatar" />
